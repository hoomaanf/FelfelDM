...
def get_category_from_extension(ext: str) -> str:
    categories = {
        '🎬 Video': ['mp4', 'mkv', 'avi', 'mov', 'wmv', 'flv', 'webm', 'm4v', '3gp', 'mpg', 'mpeg', 'ts', 'm2ts'],
        '🎵 Audio': ['mp3', 'wav', 'flac', 'aac', 'ogg', 'm4a', 'wma', 'opus', 'alac', 'dsd'],
        '📦 Archive': ['zip', 'rar', '7z', 'tar', 'gz', 'bz2', 'xz', 'iso', 'img', 'dmg', 'cab', 'arj', 'lzh', 'tgz', 'zst'],
        '📄 Document': ['pdf', 'doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx', 'odt', 'ods', 'odp', 'txt', 'rtf', 'md', 'csv', 'tsv'],
        '🖼️ Image': ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'svg', 'webp', 'ico', 'tiff', 'tif', 'raw', 'psd', 'ai', 'eps', 'heic', 'heif'],
        '⚙️ Program': ['exe', 'msi', 'deb', 'rpm', 'apk', 'app', 'pkg', 'sh', 'bat', 'cmd', 'py', 'jar', 'war', 'dmg', 'flatpak'],
        '💻 Code': ['py', 'js', 'html', 'css', 'php', 'java', 'c', 'cpp', 'h', 'go', 'rs', 'ts', 'json', 'xml', 'yaml', 'toml', 'sql', 'sh', 'rb', 'pl', 'lua', 'r', 'swift', 'kt', 'dart'],
